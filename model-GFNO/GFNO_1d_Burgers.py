...
parser.add_argument('--num', type=int, default =  1,  help='the num of Gabor filters, the default is 1')
parser.add_argument('--len', type=int, default = 201,  help='the length of 1-d Gabor filters in time domain')
parser.add_argument('--ex', type=float, default = 0.998,  help='the decay rate of exponential decay learning rate')
parser.add_argument('--epoch', type=int, default = 5000,  help='epoch')
parser.add_argument('--sub', type=int, default = 16,  help='sample rate for resolution')
parser.add_argument('--width', type=int, default=64, help='the width in the original FNO')
...
ex = args.ex
epoch = args.epoch
szie = 2**13 // args.sub    # the data resolution after sampling
...
for ep in range(epochs):
    ...
    if ep % 100 == 0 or ep == 999 or ep == 4999:
