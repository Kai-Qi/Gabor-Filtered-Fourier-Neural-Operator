...
parser.add_argument('--learning_rate', type=float, default=0.019, help='Learning rate')
...
parser.add_argument('--width', type=int, default=20, help='the width in the original FNO')
...
TRAIN_PATH = '/media/datadisk/Mycode/1.My-DNN-Practice/Neural_Operator_Data/ns_V1e-4_N10000_T30.mat'
sub = 1
S = 64
T_in = 10
T = 20
...
# torch.save(model, '/media/datadisk/Mycode/1.My-DNN-Practice/0.FNO_GaborFilter_Ours/3d_problem/'+ name1)
