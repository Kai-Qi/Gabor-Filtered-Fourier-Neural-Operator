...
parser.add_argument('--learning_rate', type=float, default=0.020, help='Learning rate')
parser.add_argument('--len', type=int, default=7, help='the length of 2-d Gabor filters in time domain: len * len')
parser.add_argument('--sample', type=int, default=25, help='the number of grid point when compute losss function to train model')
