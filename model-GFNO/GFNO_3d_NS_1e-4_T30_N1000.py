...
parser.add_argument('--learning_rate', type=float, default=0.018, help='Learning rate')
parser.add_argument('--len', type=int, default=11, help='the length of 2-d Gabor filters in time domain: len * len')
parser.add_argument('--size_frequency', type=int, default=74, help='size of Gabor filter in frequency domain: data_size + length of Gabor filter in time domain - 1')
...
TRAIN_PATH = '/media/datadisk/Mycode/1.My-DNN-Practice/Neural_Operator_Data/ns_V1e-4_N1200_T30.mat'
sub = 1
S = 64
T_in = 10
T = 20
...
train_a = reader.read_field('uu')[:ntrain,::sub,::sub,:T_in]
train_u = reader.read_field('uu')[:ntrain,::sub,::sub,T_in:T+T_in]

test_a = reader.read_field('uu')[-ntest:,::sub,::sub,:T_in]
test_u = reader.read_field('uu')[-ntest:,::sub,::sub,T_in:T+T_in]
