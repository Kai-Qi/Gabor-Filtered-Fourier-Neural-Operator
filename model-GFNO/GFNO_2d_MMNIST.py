...
parser.add_argument('--num', type=int, default=1, help='the num of Gabor filters')
...
parser.add_argument('--p', type=int, default=168, help='the number of grid point when compute losss function to train model')
