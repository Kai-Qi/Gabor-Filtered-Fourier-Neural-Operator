...
parser.add_argument('--learning_rate', type=float, default=0.028, help='Learning rate')
...
parser.add_argument('--p', type=int, default=144, help='the number of grid point when compute losss function to train model')
