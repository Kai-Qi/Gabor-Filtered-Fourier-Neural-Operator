...
parser.add_argument('--visc', type=float, default=1e-5, help='the viscosity (1/Re) in NS equation')
...
for j in range(N//bsize):
    ...
    #Solve NS
    sol, sol_t = navier_stokes_2d(w0, f, args.visc, 50.0, 1e-4, record_steps)
...
io.savemat('/home/qikai/Computers_and_Fluids_Revise/new_NS_data/' + 'NS_data_T50_N1200_V_' + name1+ '.mat', 
